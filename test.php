...
function addAllRecursion($Array, &$SumInt) {                // Function with array and reference int
    if (count($Array) > 0) {                        // Elements counted and checked if greater than 0
        ...
        array_shift($Array);                        // Removes first element of array
        addAllRecursion($Array, $SumInt);                   // Recurs the function
    }
}
$SumInt = 0;
addAllRecursion([1,1,1,1,1],$SumInt);                       // Assigns values to $Array
